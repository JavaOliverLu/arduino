...
#include "DoReMi.h"
//= 尋線用馬達轉速 =
byte MR_SL=190;//org 160
byte ML_SL=190;//org160
//== 尋線轉彎轉速 ==
byte MR_S=80;
byte ML_S=80;
//= 藍芽用馬達轉速 
...
boolean LINE = false;
#define RRv 350 //最右邊尋跡紅外線數值,白底>黑線org300
#define Rv  350 //右邊尋跡紅外線數值,白底>黑線org300
#define Lv  350 //左邊尋跡紅外線數值,白底>黑線org300
#define LLv 350 //最左邊尋跡紅外線數值,白底>黑線org300
//==================
void setup()
{
  Serial.begin(9600);
